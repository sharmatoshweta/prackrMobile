console.log("call.js");
myApp.controller('callController', ['$http', 'apiOne', '$mdDialog', '$mdMedia', '$scope', '$mdToast', '$timeout', '$q', '$log', 'FileUploader', function($http, apiOne, $mdDialog, $mdMedia, $scope, $mdToast, $timeout, $q, $log, FileUploader) {
